...
//{Index,Game,Lister }
ReactDOM.render(<MyRouter home={Index} routes={{Index,Highlight,Clickers,Sequence,GroupTest,TabsPage,Parent,Parent2,ModalPage,ModalPage2,ContextDemo,ContextDemoProp,Game,Lister,Svgdemo,Download,InputColor,InputColorP,ColorGrid}} />,document.getElementById('root'));
