...
//{Index,Game,Lister }
ReactDOM.render(<MyRouter home={Index} routes={{ Index,ModalPage,ModalPage2,ContextDemo,ContextDemoProp,Game,Lister,Svgdemo,Download,InputColor,InputColorP,ColorGrid}} />,document.getElementById('root'));
